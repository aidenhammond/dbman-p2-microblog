...
public class Utility {
    ...
    public static List<FollowableUser> createSampleFollowableUserList() {
        ...
        followableUsers.add(new FollowableUser("1", "Luke", "Mullins",
                true, "Mar 07, 2024, 10:54 PM"));
        followableUsers.add(new FollowableUser("2", "Landon", "Cartrette",
                false, "Mar 05, 2024, 11:00 AM"));
        followableUsers.add(new FollowableUser("3", "Jiwon", "Park",
                true, "Mar 06, 2024, 09:30 AM"));
        followableUsers.add(new FollowableUser("4", "James", "Warren",
